...
public class GraphViz {
   ...
   */
  private static final String cfgProp = System.getProperty("user.dir") + "/config/config.properties";
   ...
   */
  private int[] dpiSizes = { 46, 51, 57, 63, 70, 78, 86, 96, 106, 116, 
  ...
  private byte[] get_img_stream(File dot, String type) {
    ...
    try {
      ...
      dpiSizes[this.currentDpiPos], dot.getAbsolutePath(), "-o",
          img.getAbsolutePath() };
